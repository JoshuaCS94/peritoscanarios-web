...
const HomePage = () => {
  return (
    <main className='h-screen'>
      <Header />
      <div className='pb-8'>
        <Image src='/background.jpg' alt='background' width={900} height={400} className='float-right ml-16' />
        <div className='pl-16 pt-40 text-center'>
          <h1 className='text-5xl font-semibold leading-snug text-blue-900'>
            Valoración de Daño Corporal y Peritaje Médico
          </h1>
          <button className='mt-12 rounded bg-blue-900 px-4 py-2 text-white'>Reservar ahora</button>
        </div>
      </div>
      <div className='clear-both grid grid-cols-2 gap-16 bg-sky-100 p-20'>
        <iframe
        ...
        <div className='flex flex-col justify-center gap-2'>
          ...
          <div className='my-4 h-0.5 w-60 bg-gray-900' />
